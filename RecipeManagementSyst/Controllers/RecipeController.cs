...
namespace RecipeManagementSystem.Controllers
{
    public class RecipeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,MealType,CookTime,Description,Instructions")] Recipe recipe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RecipeID,Name,MealType,CookTime,Description,Instructions")] Recipe recipe)
        {
